...
| | |
| --- | --- |
| Build | [![Build Status](https://github.com/trpubins/portfolio/actions/workflows/build.yaml/badge.svg)](https://github.com/trpubins/portfolio/actions/workflows/build.yaml) ![Software Version](https://img.shields.io/badge/latest-v1.3.0-blue) ![Node Versions](https://img.shields.io/badge/node-18-blue?logo=nodedotjs) |
